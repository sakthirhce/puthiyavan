...
import com.sakthi.trade.domain.zerodha.OHLCQuoteResponse;
...
public class TrendScheduler {
    ...
    public Map<String, TradeData> trendTradeMap = new HashMap<>();

    public Map<String,Double> getPreOpenStockList() throws Exception {
    ...
    public void trendScheduler() throws Exception {
   ...
   // @Scheduled(cron = "${trend.scheduler.live}")
    public void trendLive() throws Exception {
